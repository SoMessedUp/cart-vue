        ...
        <div class="cart">
            <div class="cart__contents">
                <div class="cart__heading">
                    <div class="cart__heading-info">
                        <h2 class="cart__heading-text">Ваша корзина</h2>
                        <div class="cart__heading-goods">4 товара</div>
                    </div>
                ...
                <div class="cart__additionals">
                    ...
                    <div class="card__additionals-img">
                        ...
                        <path d="M14.3601 16.2177C14.2125 16.2177 14.0649 16.1614 13.9522 16.0487C13.7269 15.8233 13.7269 15.4582 13.9522 15.2329L24.745 4.44008C24.9704 4.21472 25.3355 4.21472 25.5608 4.44008C25.7862 4.66544 25.7862 5.03052 25.5608 5.25588L14.768 16.0487C14.6553 16.1614 14.5077 16.2177 14.3601 16.2177Z" fill="#0069B4" />
                        </svg>
                    </div>
                    <div class="cart__additionals-text">
                        <div class="cart__additionals-name">Установка</div>
                        <div class="cart__additionals-explanation">Отметьте, если Вам необходима консультация профессионала по монтажу выбранных товаров.</div>
                    </div>
                </div>
            </div>
            <div class="cart__total">
                ...
                <div class="cart__total-row">
                    <div class="cart__total-text">Сумма заказа</div>
                    <div class="cart__total-value"> 50 576р</div>
                </div>
                <div class="cart__total-row">
                    <div class="cart__total-text">Количество</div>
                    <div class="cart__total-value">4 шт</div>
                </div>
                <div class="cart__total-row">
                    <div class="cart__total-text">Установка</div>
                    <div class="cart__total-value">Нет</div>
                </div>
